      ...
      >
        ...
        <div className="w-full lg:w-[60%] my-auto space-y-6">
          ...
          <p className="text-sm tracking-wider w-full lg:w-[90%] text-gray-700 leading-relaxed">
            ...
            necessitatibus voluptatum iusto repellat ipsa quidem nam
            consequuntur culpa explicabo, alias magni vero aperiam. Lorem ipsum
            dolor, sit amet consectetur adipisicing elit. Neque nesciunt harum
            porro illum deserunt facilis at expedita sint natus ullam?
          </p>
          <p className="text-sm tracking-wider w-full lg:w-[90%] text-gray-700 leading-relaxed">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae
            dolore quam voluptate accusamus corrupti dolorem incidunt
